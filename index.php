...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-mini"><b>I</b>S<b>R</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>I</b><b>S</b><b>R</b>
	  </span>
    </a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center index-head">
            <h1>Intelligent And Systematic Recuirtment</h1>
            
            <p><a class="btn btn-success btn-lg" href="jobs.php" role="button">Search Jobs</a></p>
			<p>Exclusively <strong>Train</strong> and Hire <strong>Freshers!</strong></p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="img/isr.png" alt="Browse Jobs">
              <div class="caption">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="img/1g.jpg" alt="Start A Career">
              <div class="caption">
                <h3 class="text-center">Job Training</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail company-img">
              ...
              <div class="caption">
                <h3 class="text-center">Manage Jobs</h3>
              </div>
            </div>
          </div>
          <div class="col-sm-4 col-md-4">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 about-text margin-bottom-20">
            <p>The ISR allows job seekers and recruiters to connect.The application provides the ability for job seekers to not only apply for their designated job but also get a head start for thier future job by our On-Job training course. The On-Job training is provided with the collabrated instututions which Excel in On-Job Training Programe. ISR also provides the ability for companies to create their accounts, search candidates, create job postings, and view candidates applications.
            </p>
            <p>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2020-2021 <a>ISR</a>.</strong> All rights
    reserved.
    </div>
  </footer>
