...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-mini"><b>I</b><b>S</b>R</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>ISR</span>
    </a>
                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li><a href="" class="citySearch" data-target="Nagpur"><i class="fa fa-circle-o text-yellow"></i> Nagpur</a></li>
                      <li><a href="" class="citySearch" data-target="Bangalore"><i class="fa fa-circle-o text-yellow"></i> Bangalore</a></li>
                      <li><a href="" class="citySearch" data-target="Visakhapatnam"><i class="fa fa-circle-o text-yellow"></i> Visakhapatnam</a></li>
                      <li><a href="" class="citySearch" data-target="Chennai"><i class="fa fa-circle-o text-yellow"></i> Chennai</a></li>
                      <li><a href="" class="citySearch" data-target="Ahemdabad"><i class="fa fa-circle-o text-yellow"></i> Ahemdabad</a></li>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
